...
See [Ubuntu 18.04 Package Manager - Install .NET Core](https://docs.microsoft.com/en-en/dotnet/core/install/linux-package-manager-ubuntu-1804) on [Microsoft Docs](https://docs.microsoft.com/).
